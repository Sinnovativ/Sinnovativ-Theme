...
kennzahlTl
    .from(".kennzahl-img", { duration: 1, scale: 0, ease: "back.out(2)", stagger: { from: "center", amount: 0.25 } })
    .from(".kennzahl-text-wrapper", { autoAlpha: 0, y: 40, ease: "power4.out", stagger: { from: "center", amount: 0.25 } }, "-=0.8")
...
.from(".wirkungskette-icon-1", { duration: 0.8, scale: 0, transformOrigin: "center", ease: "back.out(2)" })
.from(".wk-text-box-1", { duration: 1, x: -200, opacity: 0, ease: "power2.out"}, "-=0.6" );
...
.from(".wirkungskette-icon-2", { duration: 0.8, scale: 0, transformOrigin: "center", ease: "back.out(2)" })
.from(".wk-text-box-2", { duration: 1, x: 200, opacity: 0, ease: "power2.out"}, "-=0.6" );
...
.from(".wirkungskette-icon-3", { duration: 0.8, scale: 0, transformOrigin: "center", ease: "back.out(2)" })
.from(".wk-text-box-3", { duration: 1, x: -200, opacity: 0, ease: "power2.out"}, "-=0.6" );
...
.from(".wirkungskette-icon-4", { duration: 0.8, scale: 0, transformOrigin: "center", ease: "back.out(2)" })
.from(".wk-text-box-4", { duration: 1, x: -200, opacity: 0, ease: "power2.out"}, "-=0.6" );
...
.from(".wirkungskette-icon-5", { duration: 0.8, scale: 0, transformOrigin: "center", ease: "back.out(2)" })
.from(".wk-text-box-5", { duration: 1, x: 200, opacity: 0, ease: "power2.out"}, "-=0.6" );
...
.from(".wirkungskette-icon-6", { duration: 0.8, scale: 0, transformOrigin: "center", ease: "back.out(2)"})
.from(".wk-text-box-6", { duration: 1, x: -200, opacity: 0, ease: "power2.out"}, "-=0.6" )
